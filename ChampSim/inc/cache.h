...
class CACHE : public MEMORY {
  public:
    ...
    int  check_hit(PACKET *packet),
        ...
        //NEW ADDITION
         prefetch_line(uint64_t ip, uint64_t base_addr, uint64_t pf_addr, int prefetch_fill_level, uint32_t prefetch_metadata, uint64_t virtual_addr = 0),
        //END OF NEW ADDITION
    ...
    void add_mshr(PACKET *packet),
        ...
        //  l1d_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type),
         l1d_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint64_t virtual_addr = 0),
    ...
    uint32_t l2c_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint32_t metadata_in, uint64_t virtual_addr = 0),
        //  llc_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint32_t metadata_in),
         llc_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint32_t metadata_in, uint64_t virtual_addr = 0),
